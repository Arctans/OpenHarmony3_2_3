...
/* lwl add 20230904 */
#define MAC_UID_LOW_OFFSET	0x410
#define MAC_UID_HIGH_OFFSET	0x420
...
void imx_get_mac_from_fuse(int dev_id, unsigned char *mac)
{
	...
	{
		u32 value = readl((void *)((MAC_UID_HIGH_OFFSET + OCOTP_BASE_ADDR)));
		printf("MAC_UID1:0x%08x\n",value);
		mac[5] = value >> 24;
		mac[4] = value >> 16;
		mac[3] = value >> 8;
		mac[2] = value + dev_id;

		value = readl((void *)((MAC_UID_LOW_OFFSET + OCOTP_BASE_ADDR)));
		printf("MAC_UID0:0x%08x\n",value);
		mac[1] = value >> 8;
		mac[0] = value + dev_id;
