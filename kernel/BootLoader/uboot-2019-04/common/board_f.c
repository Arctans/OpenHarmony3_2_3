...
{
#if 0 //lwl add to read boot mode status 
	{
		unsigned int REG_SRC_SBMR1 = 0X20D8004;
		unsigned int REG_SRC_SBMR2 = 0X20D801C;
		unsigned int value = 0;

		value = readl(REG_SRC_SBMR1);
		printf("the REG_SRC_SBMR1 0x%lx\n",value); //正常启动 0x5060 or 0xa005060
		value = readl(REG_SRC_SBMR2);
		printf("the REG_SRC_SBMR2 0x%lx\n",value); // 正常启动 0x32000001
	}
#endif 
	puts("DRAM:  ");
	return 0;
